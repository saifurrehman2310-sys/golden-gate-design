...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Start Your Project | Saif Studio" },
      {
        name: "description",
        content:
          "Tell us about your business and get a plan, timeline and fixed price. Email or WhatsApp Saif Studio to start your website project.",
      },
      { property: "og:title", content: "Contact — Saif Studio" },
      { property: "og:description", content: "Start a website project with Saif Studio today." },
    ],
  }),
  component: Contact,
});
