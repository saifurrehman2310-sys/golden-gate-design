...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — Website Packages from $250 | Saif Studio" },
      {
        name: "description",
        content:
          "Transparent website pricing: Starter $250, Business $450, Premium custom. Fixed scope, fixed price, no surprises.",
      },
      { property: "og:title", content: "Pricing — Saif Studio" },
      {
        property: "og:description",
        content: "Starter $250 · Business $450 · Premium custom. Websites built to pay for themselves.",
      },
    ],
  }),
  component: Pricing,
