...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Services — Website Design, Shopify & Branding | Saif Studio" },
      {
        name: "description",
        content:
          "Website design, Shopify development, landing pages, branding, website redesign and maintenance for growing businesses in the US, Canada and worldwide.",
      },
      { property: "og:title", content: "Services — Saif Studio" },
      {
        property: "og:description",
        content: "Six services built around one outcome: more enquiries for your business.",
      },
    ],
  }),
  component: Services,
