...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — A Digital Partner, Not a Vendor | Saif Studio" },
      {
        name: "description",
        content:
          "Saif Studio helps businesses build trust online, improve their digital presence and generate consistent leads — with an engineer's approach to structure and detail.",
      },
      { property: "og:title", content: "About — Saif Studio" },
      {
        property: "og:description",
        content: "An engineering-minded studio building websites that businesses can rely on.",
      },
    ],
  }),
  component: About,
